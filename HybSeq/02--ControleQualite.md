...
Les étapes suivantes se feront toutes sur l'espace `/scratch` étant donné
 ...
 premier contrôle qualité à l'aide de
...
LOCAL=/c/Users/Etienne/Downloads
...
Notez que si vous êtes sur Windows, il faut remplacer les "backslash" (\\)
 ...
 être remplacé par "/c/". Finalement, notez que les espaces dans les noms
...
- Doit être remplacé par:
  `/c/Users/Moi/Documents/BIO' '6245/fichier' 'de' 'travail.txt`  
...
Voici le code pour effectuer toutes ces étapes (déduplication, rognage,
 filtration) sur tous les échantillons:  
```bash
## Ajuster les variables ci-dessous de façon appropriée
SRC=/opt
